  ...
  <div class="logo-wrapper w-80 -translate-y-10 opacity-0">
    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 283.5 130.6">
      ...
      <g class="logo-text">
        ...
        <path
          fill="white"
          d="M211.2 125.268L214.9 129.882V130.183H201.9V125.067H201.7C198.8 128.979 195.7 130.785 192.5 130.785C189.3 130.785 185.6 127.876 185.6 122.459V112.228L182 107.113V106.812L195.1 103V120.754C195.1 123.563 196.3 124.365 197.7 124.365C199.1 124.365 200.3 123.763 201.6 122.76V112.328L198 107.213V106.912L211.1 103.1V125.368L211.2 125.268Z"
        />
        <path
          fill="white"
